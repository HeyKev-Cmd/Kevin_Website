...
# Create your views here.
    def __init__(self):
        path= os.path.join(os.path.dirname(os.path.abspath(__file__)),'kevin_web_app','data','personal_info.json')
...
# Create your views here.
    def __init__(self):
        path= os.path.join(os.path.dirname(os.path.abspath(__file__)),'kevin_web_app','data','personasl_info.json')
        self.info=json.load(open(path,"r"))
        self.logger = logging.getLogger(__name__)
    def get(self,request):
